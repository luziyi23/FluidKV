...
standard(const void *_ptr, size_t _len,
...
static inline size_t
nohash(const void *_ptr, size_t _len,
       size_t _seed = static_cast<size_t>(0xc70f6907UL))
{
    return *(size_t *)_ptr;
}
...
static inline size_t jenkins(const void *_ptr, size_t _len,
...
//    machines.
static inline size_t murmur2(const void *key, size_t len,
...
static inline uint64_t hash_compute(const void *input, uint64_t length,
...
static inline uint64_t xxhash(const void *data, size_t length, size_t seed)
{
...
static size_t (*hash_funcs[5])(const void *key, size_t len, size_t seed) = {
    // nohash,
