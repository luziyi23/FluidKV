...
static void idx_clwb_fence(const void *addr, size_t len)
{
...
void CCEH::Insert(const Key_t &key, ValueHelper &le_helper) {
...
// bool CCEH::TryGCUpdate(const Key_t &key, ValueHelper &le_helper) {
//   auto f_hash = hash_funcs[0](&key, sizeof(Key_t), f_seed);
//   auto f_idx = (f_hash & kMask) * kNumPairPerCacheLine;
